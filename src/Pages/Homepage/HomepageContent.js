      ...
      >
        <div className="contentText section">
          <motion.h2 variants={childrenVariants}>
            We believe great design starts with an idea. A creative spark
            fuelled by a sense of curiosity that leads to a new way of finding a
            solution.
          </motion.h2>
          <motion.div variants={childrenVariants}>
            <p>
              ...
              ask the hard questions, push for excellence and never settle for
              the status quo. We understand the harder path can lead to the most
            ...
            <p>
              ...
              identity and communications, guided by our innate curiosity and
              love of strategic thinking. We thrive on transforming commercial
              challenges into creative opportunities.
            </p>
            <p>
              We’re not afraid to push and pull things apart, using insights and
              design knowledge to deepen the resonance and relevance of brands.
              We love to work with businesses looking for a different take on
              their brand, to unlock the potential at the heart of their
              product.
            </p>
          </motion.div>
        </div>
