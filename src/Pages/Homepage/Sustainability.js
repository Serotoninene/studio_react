...
export default function Sustainability({ homepageFramesVariant }) {
  ...
  return (
    <motion.div
      ...
      data-scroll-section
    >
      <motion.div variants={childrenVariants} className="contentImage section">
        <img
          src={images.manuel}
          className="img-fluid"
      ...
      <div className="contentText section">
        ...
        <motion.div variants={childrenVariants}>
          ...
          <p>
            ...
            to stop the damaging effects of plastic pollution. When plastics are
            kept out of the environment and in the economy via high value
          ...
          <p>
            ...
            design is something we’re extremely well versed in. Choosing to use
            products that can be safely reused, recycled or composted, by
            understanding how local infrastructure supports the solution. Clear
            on-pack communications on how to best disassemble, recycle or reuse
            packaging are our collective responsibility to keep products
            circulating and out of landfill.
          </p>
